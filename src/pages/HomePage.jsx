...
export default function Homepage() {
  ...
  return (
    <div className="w-full bg-white">
      ...
      <div className="block w-full h-[300px] sm:h-[500px] mb-4 sm:mb-8 bg-gradient-to-b from-stone-500 to-white xxs: mt-[20px] xxs:mt-[40px] xs:mt-[60px] ">
        <img
          src={welcome}
          className="w-full h-full object-contain"
          alt="Welcome"
      ...
      <div className="w-full flex flex-col xs:items-center md:items-center ">
        <GetAllUserProfile onDataFetched={handleDataFetched} />
        {Object.keys(groupedUsers).map((genre) => (
          <div key={genre} className="mb-4 sm:mb-8">
            <div className="flex justify-between items-center px-2 sm:px-4">
