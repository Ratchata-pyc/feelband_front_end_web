...
//   const [profileUserFriends, setProfileUserFriend] = useState([]);
...
//         setProfileUserFriend(res.data.friends);
//       } catch (err) {
//         console.log(err);
//       }
//     };
...
//     setProfileUserFriend((prev) => [...prev, authUser]);
//   };
...
//     setRelationshipToAuthUser(RELATIONSHIP_TO_AUTH_USER.UNKNOWN);
//     setProfileUserFriend((prev) => prev.filter((el) => el.id !== authUser.id));
//   };
